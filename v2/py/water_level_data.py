...
class WaterLevelSlots:
    ...
    def get_current_water_level(self):
        #print("level 1 :: " + str(self._waterLevelSlots[0].get_water_level()))
        #print("level 2 :: " + str(self._waterLevelSlots[1].get_water_level()))
        #print("level 3 :: " + str(self._waterLevelSlots[2].get_water_level()))
